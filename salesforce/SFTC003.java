...
public class SFTC003 extends ProjectSpecification {
	/*Test Steps:
		...
		*/
		...
		@Test
		public void sftcthree() throws InterruptedException {
...
//			Thread.sleep(3000);
			...
			if (verify.contains("Shanmuganathan")) {
				System.out.println("Work Type Name Verified Successfully");
			}
			else
