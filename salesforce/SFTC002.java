...
public class SFTC002 extends ProjectSpecification {

	@Test
	public void sftctwo() throws InterruptedException {
...
//				Thread.sleep(3000);
				...
				WebElement Deliverystatus = driver.findElement(By.xpath("(//button[@class='slds-combobox_input slds-input_faux fix-slds-input_faux slds-combobox_input-value'])[4]"));
