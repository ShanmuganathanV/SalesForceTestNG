...
public class SFTC006 extends ProjectSpecification{
	/*
	 * Test Steps:
...
10. Click on Save and Verify Status as Active"
	 */
	@Test
	public void sftcsix() throws InterruptedException {
...
//			Thread.sleep(3000); 
			...
			WebElement dd=driver.findElement(By.xpath("//a[text()='Salesforce Automation by Shanmuganathan']")); 
			...
			{
				System.out.println("Status Verified successfully");
			}
			else
			{		
